...
local rawServerUrl = getgenv and getgenv().ServerURL or _G.ServerURL or "https://stickyhub.com"
local serverUrl = (rawServerUrl and rawServerUrl ~= "" and not string.find(rawServerUrl, "{{")) and rawServerUrl or "https://stickyhub.com"

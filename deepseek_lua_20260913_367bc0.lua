--[[
  STICKY HUB Loader (no key system) — BLUE THEME
  Server: Zeroin Hub
  Endpoint: GET /api/script
]]
...
-- executor HWID (still sent to server for logging/analytics; not required for auth)
...
-- POST-capable HTTP (unused by the loader now, kept for utility)
...
-- ══════════════════════════════════════════════════════════════
--  UI  — loader panel (BLUE THEME)
-- ══════════════════════════════════════════════════════════════
local Gui = Instance.new("ScreenGui")
Gui.Name = "StickyHubLoader"
...
TopLine.BackgroundColor3 = Color3.fromRGB(59, 130, 246)
...
BrandDot.BackgroundColor3 = Color3.fromRGB(59, 130, 246)
...
Title.TextColor3 = Color3.fromRGB(219, 234, 254)
...
Badge.Position = UDim2.new(0, 140, 0, 13)
Badge.BackgroundColor3 = Color3.fromRGB(15, 30, 60)
...
BadgeStroke.Color = Color3.fromRGB(59, 130, 246)
...
BadgeText.Text = "LOAD"
BadgeText.TextColor3 = Color3.fromRGB(96, 165, 250)
...
CloseBtn.BackgroundColor3 = Color3.fromRGB(15, 23, 42)
CloseBtn.BorderSizePixel = 0
CloseBtn.Text = "X"
CloseBtn.TextColor3 = Color3.fromRGB(125, 148, 180)
...
CloseStroke.Color = Color3.fromRGB(59, 130, 246)
...
Continue.BackgroundColor3 = Color3.fromRGB(59, 130, 246)
Continue.BorderSizePixel = 0
Continue.Text = "Load Script"
Continue.TextColor3 = Color3.fromRGB(3, 10, 20)
...
DiscordBtn.BackgroundColor3 = Color3.fromRGB(15, 23, 42)
...
local function loadMainScript()
  ...
  Continue.BackgroundColor3 = Color3.fromRGB(30, 58, 138)
  Continue.TextColor3 = Color3.fromRGB(191, 219, 254)
  ...
  task.spawn(function()
    ...
    print("[STICKY] Fetching: " .. scriptUrl)

    local ok, src = pcall(function() return game:HttpGet(scriptUrl) end)
    print("[STICKY] ok=" .. tostring(ok) .. " len=" .. tostring(ok and src and #src or 0))

    if not ok or not src or #src == 0 then
      setStatus("Failed to fetch script: " .. tostring(src), Color3.fromRGB(239, 68, 68))
      Continue.Text = "Retry"
      Continue.AutoButtonColor = true
      Continue.BackgroundColor3 = Color3.fromRGB(59, 130, 246)
      Continue.TextColor3 = Color3.fromRGB(3, 10, 20)
    ...
    setStatus("Executing script...", Color3.fromRGB(96, 165, 250))
    ...
    setStatus("Loaded. Closing panel...", Color3.fromRGB(96, 165, 250))
    task.wait(0.4)
    Gui:Destroy()
  end)
end
